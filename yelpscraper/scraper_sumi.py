...
class Scraper:
    ...
    def scrape(self, MB_scraper):
        ...
        print('db host=' + 'mongodb+srv://sumi:'+urllib.parse.quote_plus('sumi@123')+'@codemarket-staging.k16z7.mongodb.net/codemarket_devasish?retryWrites=true&w=majority')
        while self.no_email and self.flag < 50:
            ...
            driver = webdriver.Chrome('C:/Users/Administrator/AppData/Local/Programs/Python/Python38-32/chromedriver.exe' ,options=chrome_options)
            try:
